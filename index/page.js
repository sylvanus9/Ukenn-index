parcelRequire = function(e, r, t, n) {
	...
	"Bb20": [function(require, module, exports) {
		...
		function e() {
			var e = ["或许你自己不这么认为，<br>但你光是这样或者就是作品了。", "皎如飞镜临丹阙<br>绿烟灭尽清辉发", "在他软弱时<br>他用一朵花作为配饰<br>去跟世界决斗", "过好每一天，<br>就是对无奈人生最好的报复", "遍撒珍珠,笑声朗朗,<br>用希望和轻盈的幻想让我惊喜。<br>平和闪耀,清新,冰凉。", "每个人<br>都有一个世界<br>安静而孤独", "连接遥远的过去与未来,<br>我们为此而存在……"],
				i = o(0, e.length - 1);
			t("#slogan").html(e[i])
		}
		function o(t, e) {
